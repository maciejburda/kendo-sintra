...
export const ui = {
  en: {
    ...
    'course.duration.value': '3 months · Wednesdays',
    'course.shinai': 'Shinai',
    'course.shinai.value': 'Included, yours to keep',
    'course.lead': 'Three months, once a week on Wednesdays, for adults with no experience. Taught in English with Japanese commands, translated to Portuguese.',
    ...
    'signup.or': 'Prefer to talk to someone? Call or write to us.',
    ...
    'map.note': 'The map is loaded from Google only after you click, so this page stays free of cookies until then.',
  ...
  pt: {
    ...
    'course.duration.value': '3 meses · às quartas-feiras',
    'course.shinai': 'Shinai',
    'course.shinai.value': 'Incluído, fica para si',
    'course.lead': 'Três meses, uma vez por semana às quartas-feiras, para adultos sem experiência. Aulas em inglês com comandos em japonês e tradução para português.',
    ...
    'signup.or': 'Prefere falar com alguém? Ligue-nos ou escreva.',
    ...
    'map.load': 'Carregar o mapa',
    'map.note': 'O mapa só é carregado do Google depois de clicar, para que esta página fique sem cookies até lá.',
