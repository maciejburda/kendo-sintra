...
export const ui = {
  en: {
    ...
    'map.note': 'The map is provided by Google, which may set cookies in your browser.',
  ...
  pt: {
    ...
    'map.note': 'O mapa é fornecido pelo Google, que pode guardar cookies no seu navegador.',
